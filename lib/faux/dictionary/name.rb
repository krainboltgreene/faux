  ...
  module Dictionary
    module Name
      def self.male_first_names
        %w[James John Robert Michael William David Richard
      ...
      def self.female_first_names
        %w[Mary Patricia Linda Barbara Elizabeth Jennifer Maria
      ...
      def self.last_names
        %w[Smith Johnson Williams Jones Brown Davis Miller
          ...
          Day Mendoza Moreno Bowman Medina Fowler]
      end
    end
  end
end
